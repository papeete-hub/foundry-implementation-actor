...
# Identifiers belonging to the instance this package was extracted from, plus the shapes a lab
# reference usually takes. Extend this when a new instance is founded; nothing here should ever
# be authored against a client in the first place, but defence in depth is cheap.
FORBIDDEN = re.compile(
    r"bnk|rlvr|reliever|banking-governance|banking-tech|banking-knowledge|papeete-foundry",
    re.IGNORECASE,
)
